...
Ultrasonografická endokavitální sonda, která se zavádí do pochvy 

Detailnější zobrazení dělohy, pochvy, vaječníků

Transabdominální ultrazvuk 
Transabdominální ultrazvuk je ultrazvuk gynekologických orgánů. 
...
Játra 
Alkohol 
Nutno omezit příjem kofeinu 
šalvěj, jitrocel nebo mateřídouška
...
Základní Otázky:
poslední prohlídka u gynekologa 
poslední návštěva mamografického screeningu (MG/UZ),
první den poslední menstruace (PM) – přesné datum, v případě postmenopauzální ženy v kolika letech;
pravidelnost a délka cyklu a počet krvácivých dní – zapisuje se zlomkem, např. 28/5; zajímá nás také intenzita krvácení, intenzita bolesti; ideální je vyplněný menstruační kalendář
počet gestací – kolikrát byla žena těhotná;
počet spontánních porodů,
počet císařských řezů,
počet spontánních potratů,
počet umělých přerušení těhotenství – zda interrupce nebo miniinterrupce,
používání hormonální antikoncepce – jaká, jak dlouho
gynekologická onemocnění v rodině, zejména zhoubné nádory – příbuzní s malignitou jsou hlavním rizikovým faktorem pro karcinom prsu,
